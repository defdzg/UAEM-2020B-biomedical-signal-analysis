...
[hdr, record] = edfread('data/chb01_01.edf'); %edfread es una función utilizada para leer la señal
...
% e) Contesta ¿qué se observa del promedio de los espectros !FALTANTE
% Comprobar resultados de unidades del espectro de potencia en las gráficas
% generadas en comparación a la presentada en:
